...
namespace Display
{
    ...
    public partial class SlipPress : UserControl
    {
        public SlipPress(DataTable datatable)
        {
            DataContext = new ViewModelSlipPress(datatable);
            InitializeComponent();
        }
    }

    public class ViewModelSlipPress : Common
    {
        //変数
        ...
        //コンストラクター
        public ViewModelSlipPress(DataTable datatable)
        {
