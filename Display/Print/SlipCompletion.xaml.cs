...
namespace Display
{
    ...
    public partial class SlipCompletion : UserControl
    {
        public SlipCompletion(DataTable datatable)
        {
            DataContext = new ViewModelSlipCompletion(datatable);
            InitializeComponent();
        }
    }

    public class ViewModelSlipCompletion : Common
    {
        //変数
        ...
        //コンストラクター
        public ViewModelSlipCompletion(DataTable datatable)
        {
