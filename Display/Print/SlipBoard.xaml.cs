...
namespace Display
{
    ...
    public partial class SlipBoard : UserControl
    {
        public SlipBoard(DataTable datatable)
        {
            DataContext = new ViewModelSlipBoard(datatable);
            InitializeComponent();
        }
    }

    public class ViewModelSlipBoard : Common
    {
        //変数
        ...
        //コンストラクター
        public ViewModelSlipBoard(DataTable datatable)
        {
